      ...
      <section className="section">
        <div className="container-page max-w-3xl space-y-8 text-[15px] leading-relaxed text-foreground/90">
          <section className="space-y-3">
            ...
            <p>
              يوفّر موقع {SITE_NAME} معلومات عن خدماتنا الرقمية. استمرارك في التصفح يعني موافقتك على
              هذه الشروط وعلى{" "}
          ...
          <section className="space-y-3">
            ...
            <p>
              المحتوى المنشور للتعريف بخدماتنا ولا يُعد عرضاً ملزماً أو عقداً إلا بعد اتفاق كتابي
              منفصل (عرض سعر / عقد خدمة). الأسعار والنطاقات تُحدَّد حسب كل مشروع.
            </p>
          </section>
          <section className="space-y-3">
          ...
          <section className="space-y-3">
            ...
            <p>
              نسعى لتقديم عمل احترافي وفق أفضل الممارسات. نتائج SEO والإعلانات والمبيعات تعتمد على
              عوامل متعددة خارج سيطرتنا الكاملة (خوارزميات محركات البحث، ميزانية الإعلان، جودة
              المنتج، إلخ)، ولا نضمن ترتيباً أو عائداً محدداً ما لم يُنص على ذلك صراحة في العقد.
            </p>
          </section>
          <section className="space-y-3">
            <h2 className="text-xl font-bold">5. الملكية الفكرية</h2>
            <p>
              تصاميم وعلامات ومواد {SITE_NAME} محمية. تسليم حقوق العمل للعميل يتم وفق بنود العقد
              المتفق عليه لكل مشروع.
            </p>
          </section>
          <section className="space-y-3">
            <h2 className="text-xl font-bold">6. إخلاء المسؤولية</h2>
            <p>
              نقدّم الموقع «كما هو». لا نتحمل مسؤولية عن أضرار غير مباشرة ناتجة عن الاعتماد على
              محتوى عام في الموقع دون تعاقد.
            </p>
          </section>
          <section className="space-y-3">
