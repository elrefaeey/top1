...
export const SEO_LANDING_PAGES: LandingPageContent[] = [
  ...
  },
  {
    ...
    faqs: [
      ...
      {
        question: "ما الفرق بين صفحة جدة والصفحة الوطنية؟",
        answer:
          "صفحة جدة تستهدف نية البحث المحلية (تصميم مواقع في جدة). الصفحة الوطنية تغطي السعودية عموماً وتربط بين المدن.",
      },
      {
        question: "هل الموقع جاهز لكلمات جدة في Google؟",
        answer:
          "نبني هيكل عناوين ووصف وسرعة جوال مناسبة كأساس SEO محلي. الحملات أو SEO المتقدم يمكن إضافتهما لاحقاً حسب احتياجك.",
      },
    ],
    relatedServiceSlug: "web-design",
    areaServed: [
  ...
  },
  {
    ...
    intro: [
      "الدمام مركز أعمال وصناعة وخدمات في المنطقة الشرقية — المنافسة الرقمية تتزايد بين الشركات التي تريد استفسارات محلية واضحة. Top1Markting تبني مواقع تساعد شركات الدمام على الظهور وجذب طلبات جادة.",
      "نركز على تجربة عربية سليمة، سرعة الجوال، وهيكل محتوى يناسب البحث المحلي في الدمام والخبر والشرقية — مع مسارات واتساب ونماذج منخفضة الاحتكاك.",
      "هذه الصفحة مخصّصة لنية «تصميم مواقع في الدمام»، وليست نسخة عامة من صفحات المدن الأخرى.",
    ],
    features: [
    ...
    faqs: [
      {
        ...
        answer:
          "نعم — لدينا صفحة مخصصة للخبر، ونخدم عموم المنطقة الشرقية مع تمييز نية كل مدينة.",
      },
      {
        question: "هل تصميم مواقع الدمام مناسب للشركات الصناعية والخدمية؟",
        answer:
          "نعم. نضبط هيكل الخدمات والعروض حسب قطاعك (B2B أو استهلاكي) مع تركيز على الاستفسارات المؤهلة لا النقرات فقط.",
      },
      {
        question: "كيف تختلف صفحة الدمام عن صفحة الخبر؟",
        answer:
          "كل صفحة تستهدف كلمات ونية محلية مختلفة. المحتوى والروابط الداخلية تشير للمدينة الصحيحة لتقليل التداخل في النتائج.",
      },
    ],
    relatedServiceSlug: "web-design",
    areaServed: [
  ...
  },
  {
    ...
    intro: [
      "الخبر سوق حيوي في الشرقية يعتمد كثيراً على الجوال والتواصل السريع. موقعك يجب أن يعكس احترافية خدماتك ويجلب استفسارات — لا مجرد معرض صور.",
      "نغطي المواقع التعريفية وصفحات الهبوط مع SEO محلي مناسب للخبر، مع ربط واضح بصفحات الدمام والشرقية عند الحاجة.",
      "نفرّق محتوى الخبر عن الدمام عمداً حتى لا تتنافس الصفحتان على نفس النية المحلية.",
    ],
    features: [
      "تصميم RTL احترافي",
      "SEO محلي للخبر",
    ...
    faqs: [
      ...
      {
        question: "هل صفحة الخبر مناسبة للمتاجر والعيادات والمكاتب؟",
        answer:
          "نعم. نضبط هيكل الصفحات حسب نوع النشاط، مع مسارات تواصل مباشرة تناسب سلوك المستخدم في الشرقية.",
      },
      {
        question: "هل يمكن ربط الموقع لاحقاً بـ SEO أو إعلانات؟",
        answer:
          "نعم. نبني أساساً تقنياً نظيفاً يسهل إضافة تحسين محركات البحث أو الحملات عند جاهزيتك.",
      },
    ],
    relatedServiceSlug: "web-design",
    areaServed: [
  ...
  },
  {
    ...
    intro: [
      "الشارقة سوق متنامٍ يحتاج حضوراً رقمياً واضحاً للشركات المحلية والعلامات التي تستهدف الإمارات. Top1Markting تبني مواقع تساعد على التعريف بالخدمات وجذب العملاء.",
      "نركز على تجربة عربية أو ثنائية اللغة عند الحاجة، وسرعة الجوال، وSEO محلي للشارقة — مع روابط واضحة لدبي وأبوظبي دون تكرار المحتوى.",
      "هذه الصفحة موجّهة لنية البحث في الشارقة تحديداً، وليست نسخة من صفحة دبي.",
    ],
    features: [
    ...
    faqs: [
      ...
      {
        question: "هل الموقع يمكن أن يكون عربي/إنجليزي؟",
        answer:
          "نعم عند الحاجة. نحدد اللغة الأساسية حسب جمهورك في الشارقة ثم نضيف الطبقة الثانية بطريقة لا تضعف SEO.",
      },
      {
        question: "ما الفرق بين صفحة الشارقة وصفحة دبي؟",
        answer:
          "كل صفحة تستهدف نية وكلمات محلية مختلفة، مع محتوى وروابط داخلية تخص المدينة لتفادي التداخل في نتائج البحث.",
      },
    ],
    relatedServiceSlug: "web-design",
    areaServed: [
