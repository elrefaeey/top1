...
export async function listSeoInsights(limit = 50): Promise<SeoInsight[]> {
  ...
  return docs.map((d) => ({
    ...
    page: asString(d.page) || asString(d.targetPage),
    targetPage: asString(d.targetPage) || asString(d.page),
    issue: asString(d.issue),
    opportunity: asString(d.opportunity),
    recommended_action: asString(d.recommended_action) || asString(d.recommendation),
    suggested_title: asString(d.suggested_title),
    suggested_content: asString(d.suggested_content),
    estimated_value: asNumber(d.estimated_value),
    ...
    recommendation: asString(d.recommendation) || asString(d.recommended_action),
