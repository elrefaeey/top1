...
export const SERVICE_SEO_CONTENT: Record<string, ServiceSeoBlock> = {
  "web-design": {
    intro: [
      "في عالم يتنافس فيه آلاف الشركات على انتباه العميل خلال ثوانٍ، أصبح الموقع الإلكتروني واجهتك الرسمية الأولى — وليس مجرد كتالوج رقمي. Top1Markting وكالة رقمية تخدم السعودية والإمارات، مع التركيز على تحويل الزوار إلى عملاء حقيقيين عبر تجربة بصرية متقنة وأداء تقني عالٍ.",
      ...
      "فريقنا يجمع بين التصميم الجمالي والهندسة التقنية: نستخدم أحدث تقنيات الويب لبناء مواقع خفيفة، آمنة، وسهلة الإدارة من لوحة تحكم. سواء كنت شركة ناشئة في الرياض أو مؤسسة راسخة في دبي، نقدم لك موقعاً يعكس احترافيتك ويقود نموك الرقمي في سوق الخليج.",
    ],
    whyChooseUs: [
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: "نعم، نوفر باقات صيانة شهرية تشمل التحديثات والنسخ الاحتياطي والدعم الفني.",
      },
    ],
  },
  "web-apps": {
    intro: [
      "المتجر الإلكتروني لم يعد رفاهية — بل ضرورة لكل شركة تريد البيع على مدار الساعة. Top1Markting متخصصة في تصميم وتطوير متاجر إلكترونية احترافية تدعم الدفع الإلكتروني، إدارة المخزون، والتكامل مع شركات الشحن في مصر والخليج.",
    ...
    faqs: [
      ...
      {
        question: "هل يدعم المتجر الدفع بالفيزا ومدى وفودافون كاش؟",
        answer: "نعم، نتكامل مع بوابات الدفع المحلية والعالمية حسب احتياجك.",
      },
      {
        question: "كم تكلفة تصميم متجر إلكتروني؟",
        answer: "تختلف حسب عدد المنتجات والميزات. تواصل معنا للحصول على عرض سعر مخصص خلال 48 ساعة.",
      },
    ],
  },
  seo: {
    intro: [
      "الظهور في الصفحة الأولى من Google ليس حظاً — بل نتيجة استراتيجية SEO مدروسة ومستمرة. Top1Markting تقدم خدمات تحسين محركات البحث الشاملة للشركات في السعودية والإمارات، من التدقيق التقني إلى استراتيجية المحتوى وبناء الروابط.",
      ...
      "نستهدف كلمات مفتاحية عالية القيمة مثل «شركة تصميم مواقع»، «تصميم متجر إلكتروني»، «خدمات SEO» — مع التركيز على نية البحث المحلية في السعودية والإمارات.",
    ],
    whyChooseUs: [
    ...
    faqs: [
      {
        ...
        answer: "التحسينات التقنية تظهر خلال 2-4 أسابيع. النتائج العضوية الكبيرة تحتاج 3-6 أشهر حسب المنافسة.",
      },
      {
        question: "هل تضمنون الصفحة الأولى في Google؟",
        answer: "لا يمكن لأي شركة ضمان ترتيب محدد. نضمن منهجية احترافية وتقارير شفافة وأهدافاً واقعية.",
      },
      {
        question: "هل تكتبون محتوى المدونة أيضاً؟",
        answer: "نعم، نقدم خدمة كتابة محتوى SEO بالعربية ضمن باقاتنا الشاملة.",
      },
    ],
  },
  "ui-ux": {
    ...
    faqs: [
      {
        ...
        answer: "UX هو تجربة المستخدم الكاملة (سهولة الاستخدام، المسار). UI هو الشكل البصري (ألوان، خطوط، أزرار). نقدم الاثنين معاً.",
      },
      {
  ...
  "digital-solutions": {
    ...
    whyChooseUs: [
      ...
      "حلول مخصصة — لا باقات جامدة غير مناسبة",
    ],
    faqs: [
      {
        question: "ما الفرق بين التسويق الرقمي وSEO؟",
        answer: "SEO نمو عضوي طويل المدى. التسويق الرقمي (إعلانات) نتائج فورية مدفوعة. الأفضل الجمع بينهما.",
      },
      {
