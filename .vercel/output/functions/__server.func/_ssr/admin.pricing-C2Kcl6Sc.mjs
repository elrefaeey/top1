...
import { D as useDeletePricingPlan, h as useAdminPricing } from "./use-admin-cms-igTQWEoU.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/admin.pricing-C2Kcl6Sc.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AdminPageHeader, {
				title: "الأسعار",
				description: "باقات التسعير.",
				actionTo: "/admin/pricing/$id",
				actionParams: { id: "new" },
			...
			data.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Table, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableHeader, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TableRow, { children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableHead, { children: "السعر" }),
...
//#endregion
export { AdminPricingList as component };
