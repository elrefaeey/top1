...
//#region node_modules/.nitro/vite/services/ssr/assets/site-images-D0ev85AD.js
/** Curated stock imagery — replace with CMS uploads in production. */
function unsplash(photoId, width = 1200) {
...
var siteImages = {
	...
	contact: {
		side: unsplash("photo-1423666639045-f560002c9368", 1e3),
...
function serviceImage(slug) {
	return siteImages.services[slug] ?? siteImages.services.default;
}
function blogImage(slug) {
	return siteImages.blog[slug] ?? siteImages.blog.default;
}
function testimonialAvatar(id) {
	return siteImages.testimonials[id];
}
//#endregion
export { testimonialAvatar as i, serviceImage as n, siteImages as r, blogImage as t };
